...
<head>
  ...
  <title>Future Mind Script</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link href="future.jpg" rel="icon" type="image/x-icon"/>
  ...
  <meta name="keywords" content="online refer script, refer bypass script, task bypass script.">
     <meta charset="UTF-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <link rel="preconnect" href="https://fonts.googleapis.com"> <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin> <link href="https://fonts.googleapis.com/css2?family=Bree+Serif&family=Montserrat:wght@400;600&display=swap" rel="stylesheet"> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">  <title> Future Mind Script</title></head>
<style>
...
border: 2px solid rgb(0, 141, 146);
  ...
  outline: none;margin-top: 0px; margin-bottom: 0px;
  }
.input{ border: 1.5px solid rgb(211, 211, 211); background-color: transparent; padding: 0 15px; transition: 0.5s; }
 ...
 select { width: 100%; height: 65px; margin: 15px 0; border-radius: 4px;		padding:0 20px;		font-size: 15px;		outline: none; font-family: 'Bree Serif', serif; }</style><body> <div class="limiter"></style>
</style>
<body>
  ...
  <h2 class="active"> Nojoto Refer Script</h2> </div> 
...
<font color='green' size='3'><b>Refer Done Successfully!</b></font></div></center><hr>";
$ma=file_get_contents("rell.txt");
$r=$ma+1;
$mjj=file_put_contents("rell.txt","$r");
	echo"<hr class='style5'></font></center><meta http-equiv='refresh' content=1;url=https://t.me/futuremindp>";
	mkdir("ab");
...
<font color='red' size='3'><b>Refer Failed</b></font></div></center><hr>";
	...
	<input type="tel" name="refer" placeholder="Enter Refer Code" required>
...
<div id="formFooter">
        <a class="underlineHover" href="https://t.me/futuremindp">Jᴏɪɴ Oᴜʀ Tᴇʟᴇɢʀᴀᴍ Cʜᴀɴɴᴇʟ</a>
      </div>
    ...
    <center> 
<a href="https://youtube.com/channel/UCFofXF9IDZWP3DR-E8YQd2A"><button type="submit" class="button"><i class="fa fa-youtube"></i><td></td>SUBSCRIBE
          </button></a>
          </center>
          <style>
          	.button{
  ...
  box-shadow: 0 12px 20px 0 rgba(0,0,0,0.2), 0 10px 25px 0 rgba(0,0,0,0.19);
}
